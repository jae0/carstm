...
# out[ out>1e10] = NA
RES$INLA.Envir.AR1.iid_year = colSums( {out * weight_year * sppoly$sa_strata_km2}[sppoly$strata_to_keep, ], na.rm=TRUE )
...
# out[ out>1e10] = NA
RES$INLA.Envir.CAR = colSums( {out * weight_year * sppoly$sa_strata_km2}[sppoly$strata_to_keep, ], na.rm=TRUE )
...
RES$INLA.Envir.AR1.CAR_year = colSums( {out * weight_year * sppoly$sa_strata_km2}[sppoly$strata_to_keep,], na.rm=TRUE )
...
RES$INLA.Envir.AR1_strata.CAR = colSums( {out * weight_year * sppoly$sa_strata_km2}[sppoly$strata_to_keep,], na.rm=TRUE )
...
RES$INLA.Envir.AR1_strata.CAR_year = colSums( {out * weight_year * sppoly$sa_strata_km2}[sppoly$strata_to_keep,], na.rm=TRUE )
...
RES$INLA.Envir.yr_iid.CAR_year = colSums( {out * weight_year * sppoly$sa_strata_km2}[sppoly$strata_to_keep,], na.rm=TRUE )
