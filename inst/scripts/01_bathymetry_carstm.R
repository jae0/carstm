...
# example sequence to force creating of input data for modelling
  ...
  M = bathymetry.db( p=p, DS="aggregated_data", data_root_override=TRUE, redo=TRUE )  # will redo if not found .. not used here but used for data matching/lookup in other aegis projects that use bathymetry
